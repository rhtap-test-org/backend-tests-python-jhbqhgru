...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/backend-tests-python-jhbqhgru:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/backend-tests-python-jhbqhgru-gitops
